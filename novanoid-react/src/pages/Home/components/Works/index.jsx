...
function Work() {
  ...
  const work = {
    workFilter: { animation: ' fadeout, zoomout', animationDuration: '0.5s', animationFillMode: 'forwards' },
    workUnfilter: { animation: 'fade, zoomin', animationDuration: '0.5s', animationFillMode: 'forwards' },
  };
  function allBtn() {
    ...
    work1.current.style = work.workUnfilter;
    // work1.current.classList.remove('work-animation-filter');
    work2.current.classList.remove('work-animation-filter');
    work3.current.classList.remove('work-animation-filter');
    work4.current.classList.remove('work-animation-filter');
    work5.current.classList.remove('work-animation-filter');
    work6.current.classList.remove('work-animation-filter');
    work7.current.classList.remove('work-animation-filter');
    work8.current.classList.remove('work-animation-filter');
    work9.current.classList.remove('work-animation-filter');

    // work1.current.classList.add('work-image-unfilter');
    work2.current.classList.add('work-image-unfilter');
    work3.current.classList.add('work-image-unfilter');
    work4.current.classList.add('work-image-unfilter');
    work5.current.classList.add('work-image-unfilter');
    work6.current.classList.add('work-image-unfilter');
    work7.current.classList.add('work-image-unfilter');
    work8.current.classList.add('work-image-unfilter');
    work9.current.classList.add('work-image-unfilter');
  ...
  function travelBtn() {
    ...
    work1.current.style = work.workUnfilter;
    // work1.current.classList.remove('work-animation-filter');
    work2.current.classList.add('work-animation-filter');
    work3.current.classList.remove('work-animation-filter');
    work4.current.classList.add('work-animation-filter');
    work5.current.classList.remove('work-animation-filter');
    work6.current.classList.add('work-animation-filter');
    work7.current.classList.add('work-animation-filter');
    work8.current.classList.add('work-animation-filter');
    work9.current.classList.remove('work-animation-filter');

    // work1.current.classList.add('work-image-unfilter');
    work2.current.classList.remove('work-image-unfilter');
    work3.current.classList.add('work-image-unfilter');
    work4.current.classList.remove('work-image-unfilter');
    work5.current.classList.add('work-image-unfilter');
    work6.current.classList.remove('work-image-unfilter');
    work7.current.classList.remove('work-image-unfilter');
    work8.current.classList.remove('work-image-unfilter');
    work9.current.classList.add('work-image-unfilter');
  ...
  function roadlBtn() {
    ...
    var btnMountains = document.getElementById('btn-mountains').classList;
    var btnNature = document.getElementById('btn-nature').classList;
    work1.current.style = work.workFilter;
    // work1.current.classList.add('work-animation-filter');
    work2.current.classList.remove('work-animation-filter');
    work3.current.classList.add('work-animation-filter');
    work4.current.classList.remove('work-animation-filter');
    work5.current.classList.add('work-animation-filter');
    work6.current.classList.add('work-animation-filter');
    work7.current.classList.remove('work-animation-filter');
    work8.current.classList.add('work-animation-filter');
    work9.current.classList.remove('work-animation-filter');

    // work1.current.classList.remove('work-image-unfilter');
    work2.current.classList.add('work-image-unfilter');
    work3.current.classList.remove('work-image-unfilter');
    work4.current.classList.add('work-image-unfilter');
    work5.current.classList.remove('work-image-unfilter');
    work6.current.classList.remove('work-image-unfilter');
    work7.current.classList.add('work-image-unfilter');
    work8.current.classList.remove('work-image-unfilter');
    work9.current.classList.add('work-image-unfilter');
  ...
  function mountainsBtn() {
    ...
    var btnMountains = document.getElementById('btn-mountains').classList;
    var btnNature = document.getElementById('btn-nature').classList;
    work1.current.style.animation = work.workFilter;
    // work1.current.classList.add('work-animation-filter');
    work2.current.classList.remove('work-animation-filter');
    work3.current.classList.remove('work-animation-filter');
    work4.current.classList.add('work-animation-filter');
    ...
    work7.current.classList.add('work-animation-filter');
    work8.current.classList.remove('work-animation-filter');
    work9.current.classList.add('work-animation-filter');
    ...
    work7.current.classList.remove('work-image-unfilter');
    work8.current.classList.add('work-image-unfilter');
    work9.current.classList.remove('work-image-unfilter');
